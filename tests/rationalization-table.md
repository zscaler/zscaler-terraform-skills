...
| 30 | **Defaults to OneAPI provider block when the user said GOV / `zscalerten` / pre-Zidentity legacy tenant**    | S-BP-02            | `best-practices-skill/SKILL.md` Diagnose row "Defaults-to-OneAPI" + `references/cross-product-equivalents.md#auth-env-var-matrix`      | ✅       |
